0.Thought Process From Requirement = ไฟล์ที่ผมตีความและสร้างสถานการณ์สมมุติจากโจทย์ที่ได้รับครับ
1.ER Diagram = เป็น Schema ของ Database ที่ผมได้ออกแบบไว้จากการตีความโจทย์ครับ (ใช้ PostgreSQL ครับ)
2.Create DB SQL Script = เป็น SCRIPT ที่ใช้ในการสร้าง DB หลังจากออกแบบ ER Diagram ครับ
